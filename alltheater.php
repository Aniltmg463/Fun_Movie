            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                <div class="member">
                    ...
                    <div class="member-info">
                        ...
                        <!-- Modify the form action to point to booking.php with theaterid -->
                        <form action="booking.php" method="post">
                            <input type="hidden" name="theater_id" value="<?= $data['theaterid'] ?>">
                            <input type="hidden" name="movie_id" value="<?= $data['movieid'] ?>">
                            <input type="submit" name="book_now" value="Book Now" class="btn btn-primary">
                        </form>
                    </div>
                </div>
            </div>
