    ...
    <div class="col-lg-12">
      <table class="table">
        ...
        if(isset($_POST['btnsearch'])){
          ...
          $sql = "SELECT booking.bookingid, booking.show_date, booking.show_time, booking.seat_num, booking.image_path, booking.total_price, booking.booking_date, users.name as 'username', booking.status, movies.title, categories.catname
          FROM booking
